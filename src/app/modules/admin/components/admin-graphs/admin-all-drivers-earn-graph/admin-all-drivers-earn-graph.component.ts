...
@Component({
  selector: 'app-admin-all-drivers-earn-graph',
  templateUrl: './admin-all-drivers-earn-graph.component.html',
  styleUrls: ['./admin-all-drivers-earn-graph.component.css']
})
export class AdminAllDriversEarnGraphComponent implements OnInit {
