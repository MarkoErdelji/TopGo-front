...
@Component({
  selector: 'app-admin-all-drivers-rides-graph',
  templateUrl: './admin-all-drivers-rides-graph.component.html',
  styleUrls: ['./admin-all-drivers-rides-graph.component.css']
})
export class AdminAllDriversRidesGraphComponent implements OnInit {
